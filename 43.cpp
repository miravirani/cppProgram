...
class employe 
{
    ...
    void set()
    {
        ...
        cout<<"Enter the Empolye Basic Salary:->";
        cin>>bs;
        da=0.40*bs;
        ra=0.10*bs;
        hra=0.20*bs;
    ...
    void show()
    {
        cout<<endl<<"Employe Name:->"<<emp_name<<endl<<"Employe Number:->"<<emp_no<<endl<<"Employe Department:->"<<emp_dpt<<endl<<"Employe Salary:->"<<bs<<endl<<"DA:->"<<da<<endl<<"RA:->"<<ra<<endl<<"HRA:->"<<hra<<endl<<"Total Salary:->"<<ts;
    }
};
int main()
{
